                    ...
                    {TEAM_MEMBERS.map((member, index) => (
                        <div key={member.id}>
                            <div 
                                ...
                                className={`group flex items-center gap-3 sm:gap-4 transition-all duration-300 py-1.5 sm:py-2 cursor-none ${activeMember.id === member.id ? 'translate-x-2 sm:translate-x-4' : 'hover:translate-x-2'}`}
                            >
                                ...
                                <h3 className={`text-lg sm:text-3xl md:text-4xl font-bold uppercase transition-colors duration-300 ${activeMember.id === member.id ? 'text-black' : 'text-gray-400 group-hover:text-black'}`}>
                                    {member.name}
                                </h3>
                            </div>
                        </div>
