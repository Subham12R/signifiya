  ...
  return (
    <div className="bg-zinc-950 min-h-screen p-4 font-sans">
      ...
      <div className="flex justify-center py-10">
        <button className="bg-purple-600 text-white font-bold text-xl px-10 py-4 rounded-full border-4 border-black shadow-[6px_6px_0px_0px_#fff] hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_#fff] transition-all">
          See All Guidelines ➜
        </button>
      </div>
